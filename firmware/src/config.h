...
#define PIN_MDDS_IN1     4   // Left motor direction (LOW=fwd, HIGH=rev)
#define PIN_MDDS_AN1    17   // Left motor speed (LEDC PWM, 5kHz 8-bit)
#define PIN_MDDS_IN2    16   // Right motor direction (LOW=fwd, HIGH=rev)
#define PIN_MDDS_AN2     5   // Right motor speed (LEDC PWM, 5kHz 8-bit)

// --- Dome encoder + home sensor ---
#define PIN_DOME_ENC_A  25   // Encoder channel A (10k+20k divider)
#define PIN_DOME_ENC_B  33   // Encoder channel B (10k+20k divider)
#define PIN_DOME_HOME   26   // A3144 hall-effect home sensor (HiLetgo module, 10k+20k divider)
...
// --- Cytron MD10C dome rotation motor pins ---
// External 10k pull-down resistors required on both pins (same reason as MDDS30).
#define PIN_DOME_DIR    14   // Dome direction (LOW=fwd, HIGH=rev)
#define PIN_DOME_PWM    27   // Dome speed (LEDC PWM, 5kHz 8-bit)

// --- Pololu Maestro servo controller (Serial1) ---
#define PIN_MAESTRO_TX  32   // Serial1 TX -> Maestro RX (9600 baud)
#define PIN_MAESTRO_RX  35   // Serial1 RX <- Maestro TX (1k+2k divider)

// --- MP3 player (Serial2) ---
#define PIN_MP3_TX      19   // Serial2 TX -> MP3 RX (9600 baud)
#define PIN_MP3_RX      18   // Serial2 RX <- MP3 TX (1k+2k divider)

// --- Bubbles relay ---
#define PIN_BUBBLES     21   // On/off relay module
